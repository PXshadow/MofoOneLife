...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("MofoOneLife", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("MofoOneLife", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "MofoOneLife";
		app.meta["file"] = "MofoOneLife";
		app.meta["name"] = "MofoOneLife";
		app.meta["packageName"] = "com.sample.MofoOneLife";
